...
import TestTube from '@/assets/model/testtube_fehling'
import Dropper from '@/assets/model/Dropper_03'
  ...
  function testTubeHandler(testtube: number) {
    setState((e) => {
      ...
      setTimeout(() => {
        setState((e) => ({
          ...e,
          color: testtube == 0 ? ['blue', e.color[1]] : e.color,
        }))
      }, 6000)
      setTimeout(() => {
        setState((e) => ({
          ...e,
          color: testtube == 1 ? [e.color[0], 'red'] : e.color,
        }))
      }, 7000)
